...
!!! info "External Resources"
    - [Linux File Ownership and Permissions Guide](https://www.freecodecamp.org/) (freeCodeCamp)
    - [Understanding Chown and Chmod](https://blog.pythian.com/) (Pythian)
    - [UNIX File Permissions](https://research.unc.edu/) (UNC Research Computing)
...
!!! info "External Resources"
    - [Setuid, Setgid, and Sticky Bit](https://www.cbtnuggets.com/) (CBT Nuggets)
    - [chattr and lsattr commands](https://www.geeksforgeeks.org/) (GeeksforGeeks)
    - [Special Files in Linux](https://dev.to/) (DEV Community)
